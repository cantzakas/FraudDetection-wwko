...
On an existing GPDB installation: 
  ...
  For Greenplum 5.7.x, both libraries are available on under __Release Download Files/Greenplum Advanced Analytics__ on https://network.pivotal.io/products/pivotal-gpdb#/releases/73874/file_groups/930.
  For information on installing PostGIS and MADLib, please check https://gpdb.docs.pivotal.io/570/ref_guide/extensions/postGIS.html and https://gpdb.docs.pivotal.io/570/ref_guide/extensions/madlib.html, respectively.
