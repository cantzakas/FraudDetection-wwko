...
On an existing GPDB installation: 
  ...
  - Download + Install Madlib and Postgis. For Greenplum 5.7.x, both are available on under __Release Download Files/Greenplum Advanced Analytics__ on https://network.pivotal.io/products/pivotal-gpdb#/releases/73874/file_groups/930
