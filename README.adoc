...
* Download and Install MADLib & PostGIS:
** For Greenplum version 5.7.x, MADLib & PostGIS libraries are available on under __Release Download Files/Greenplum Advanced Analytics__ on https://network.pivotal.io/products/pivotal-gpdb#/releases/73874/file_groups/930.
** For PostGIS installation instructions, please check https://gpdb.docs.pivotal.io/570/ref_guide/extension`s/postGIS.html.z
** For MADLib installation instructions, please check https://gpdb.docs.pivotal.io/570/ref_guide/extensions/madlib.html.
...
[source,bash]
----
 $ scp scripts/zip_codes_states.csv scripts/*.s* user@host:/home/gpadmin
...
### Important note: 
1. To run the demo, we need to add the network virtual ip for gemfire. 
```[gpadmin@gpdb-sandbox network-scripts]$ cat  ifcfg-ens33:0
NM_CONTROLLED="no"
DEVICE="ens33:0"
ONBOOT="yes"
BOOTPROTO="static"
IPADDR="192.168.9.132"
NETMASK="255.255.255.0"
[gpadmin@gpdb-sandbox network-scripts]$ 
```
